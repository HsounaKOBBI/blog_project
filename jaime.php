                ...
                <div class="row">
                    <div class="col-md-10 col-lg-8 mx-auto">
                        <div class="site-heading">
                            <h1>IT's Blog</h1><span class="subheading">An Informative Blog</span></div>
                    </div>
                </div>
            </div>
        </header>
                                        ...
                                        <div class=" float-right ">
                                            <div class="container">
                                                <form name="like" method="post"> 
                                                    <button class="like__btn animated" name ="liked">
                                                        <i class="like__icon fa fa-heart"></i>
                                                        <span class="like__number">1</span>
                                                    </button>
                                                </form>
                                            </div>
                                        </div>
