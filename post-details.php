...
$sts = 1;
        $sql4 = "SELECT `id`,`likes` FROM posts WHERE status=:sts";
        ...
        foreach($results4 as $result4){
            ...
            if(isset($_POST[$pid])){ 
                ...
                $sql5="UPDATE posts SET likes=$n+1 WHERE id=:pid";
...
if (isset($_POST['submit'])) {
    ...
    $st1 = '0';
    $likes = '0';
    $sql = "INSERT INTO comments(`postid`,`name`,`email`,`comment`,`likes`,`status`) VALUES(:postid,:name2,:email,:comment,:likes,:st1)";
    ...
    if ($lastInsertId) {
        ...
        $sts = 1;
        $sql4 = "SELECT `id`,`likes` FROM comments WHERE postid=:pid AND status=:sts";
        $query = $dbh->prepare($sql4);
        $query->bindParam(':pid', $pid, PDO::PARAM_STR);
        $query->bindParam(':sts', $sts, PDO::PARAM_STR);
        $query->execute();
        ...
        foreach($results4 as $result4){
            ...
            if(isset($_POST[$comid])){ 
                ...
                $sql5="UPDATE comments SET likes=$n+1 WHERE id=:comid";
                $query = $dbh->prepare($sql5);
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-10 col-lg-8 mx-auto">
                        ...
                        $pid = intval($_GET['id']);
                        $sts = 1;
                        $sql3 = "SELECT `name`,`comment`,`postingdate`,`id`,`likes` FROM comments WHERE postid=:pid AND status=:sts";
                        ...
                        if ($query->rowCount() > 0) {
                            foreach ($results3
                                     ...
                                     as $result3) {
                                ?>
                                <div class="card my-4" id="container">
                                        ...
                                        <div class=" float-right ">
                                            <div class="container" >
                                                <form name="like" method="post"> 
                                                     ...
                                                     <button class="like__btn animated"  href="#container" name ="<?php echo htmlentities($result3->id) ;  ?>" >
                                                   
                                                        <i class="like__icon fa fa-heart"></i>
                                                        <span class="like__number"><?php echo htmlentities($result3->likes); ?></span>
                                                    </button>
                                                </form>
                                            </div>
                                        </div>
